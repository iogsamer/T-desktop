...
void CreateTrayIcon(HWND hWnd)
{
    ...
    _tcscpy_s(g_nid.szTip, _T("DarkFlix SingleInstance"));
...
static LRESULT CALLBACK DarkTrayMenuProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_PAINT:
    {
        ...
        {
            bgBase   = RGB(28, 16, 8);
            bgHover  = RGB(200, 80, 0);
            txtNormal= RGB(240, 180, 120);
            txtCheck = RGB(255, 140, 40);
            lineColor= RGB(180, 70, 0);
        }
        else
        {
            bgBase   = RGB(255, 245, 235);
            bgHover  = RGB(255, 150, 60);
            txtNormal= RGB(80, 30, 0);
            txtCheck = RGB(200, 60, 0);
            lineColor= RGB(220, 120, 50);
        }
