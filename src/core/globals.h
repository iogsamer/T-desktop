...
// App info
// -----------------------------------------------------------------------------
#define APP_TITLE "DarkFlix - Freedom to Stream"
#define APP_NAME  "DarkFlix"
#define APP_CLASS L"DarkFlix"
...
extern std::atomic_bool g_authRunning;
extern HANDLE           g_authProcess;

// ── DarkFlix service ports (single source of truth, fix vuln #8) ─
static constexpr WORD DARKFLIX_AUTH_PORT = 11471;
...
#define WM_AUTH_DONE         (WM_USER + 201)   // auth portal completed
...
// ── Pre-configured DarkFlix addons (auto-install after login) ────
// These are installed into Stremio via g_scriptQueue after auth.
static const std::vector<std::string> DARKFLIX_ADDONS = {
    // OpenSubtitles Pro (Arabic subtitles)
    ...
    // Torrentio (sorted by quality+size, Arabic language filter)
